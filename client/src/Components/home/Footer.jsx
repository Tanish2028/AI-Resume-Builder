  ...
  return (
    ...
    <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-linear-to-r from white via-green-200/60 to white mt-40">
                <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
                    <a href="#">
                        <img src="/logo.svg" alt="loho" srcset="" className='h-11 w-auto'/>
                    </a>
                    <div>
                ...
                <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    ...
                    <div className="flex items-center gap-4 mt-3">
                        ...
                        <a href="https://www.linkedin.com/company/tanish-shrimali-78782a335" target="_blank" rel="noreferrer">
                    ...
                    <p className="mt-3 text-center">© 2026 Tanish Shrimali</p>
                </div>
            </footer>
        </>
  )

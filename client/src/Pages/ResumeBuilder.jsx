        ...
        <div className='grid lg:grid-cols-12 gap-8'>
          ...
          <div className='relative lg:col-span-5 rounded-lg overflow-visible'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              {/* progrees bar using activeSectionIndex */}
                ...
                <div className='flex items-center'>
                  {
                    activeSectionIndex !== 0 && (
                      <button onClick={()=>setActiveSectionIndex((prevIndex)=> Math.max(prevIndex-1,0))} className='flex items-center gap-1 p-3 rounded-lg text-sm font-medium text-gray-600 gover:bg-gray-50 transition-all' disabled={activeSectionIndex === 0}>
            ...
            <div className='relative w-full'>
              <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
                ...
                <button onClick={changeResumeVisibility} className='flex items-center p-2 px-4 gap-2 text-xs bg-linear-to-br from-purple-100 to-purple-200 text-purple-600 ring:purple-300 rounded-lg hover:ring transition-colors'>
                  {
                    resumeData.public ? <EyeIcon size={4}/> : <EyeOffIcon size={4}/>
                  }

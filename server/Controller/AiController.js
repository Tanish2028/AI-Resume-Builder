...
//controller function for ai generated professional summary
// post: /api/ai/pro-sum
...
export const enhanceProfessionalSummary = async (req,res) =>{
    try {
        ...
        return res.status(201).json({message:"AI enhanced Summary.",enhanceContent})
    } catch (error) {
        return res.status(400).json({message:error.message})
    }
}

//controller function for enhancing job description
...
export const enhanceJobDescription = async (req,res) =>{
    try {
        ...
        return res.status(201).json({message:"AI enhanced job description.",enhanceContent})
    } catch (error) {
        return res.status(400).json({message:error.message})
    }
}
